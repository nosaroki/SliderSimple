...
export default function Slider() {
    ...
    function toggleImage(indexPayload) {
        // let newState;
        // // Si indexPayload + le state de mon sliderIndex est supérieur à la longueur de mon tableau aka le nombre de page
...
// hook qui prend 2 arguments : l'effet qu'on veut exécuter (fonction call back), le second c'est le tableau des dépendances (valeurs que l'on veut surveiller)
    useEffect(() => {
